...
class CategoryWiseprojectModel {
  int? id;
  String? title;
  Category? program;
  Category? category;
  ...
  CategoryWiseprojectModel copyWith({
    int? id,
    String? title,
    Category? program,
    Category? category,
  ...
  factory CategoryWiseprojectModel.fromRawJson(String str) => CategoryWiseprojectModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CategoryWiseprojectModel.fromJson(Map<String, dynamic> json) => CategoryWiseprojectModel(
    id: json["id"],
    title: json["title"],
