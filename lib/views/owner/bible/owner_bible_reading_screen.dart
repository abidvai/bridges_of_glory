...
import 'package:bridges_of_glory/views/owner/bible/controller/bible_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';
import '../../../utils/constant/color.dart';

class OwnerBibleReadingScreen extends StatelessWidget {
  OwnerBibleReadingScreen({super.key});
                            ...
                            child: Center(
                              child: Obx(() {
                                return DropdownButton<String>(
                                  ...
                                  underline: SizedBox(),
                                  isExpanded: true,
                                  value: bibleController.selectedLang.value,
                                  ...
                                  onChanged: (value) {
                                    bibleController.selectedLang.value =
                                    value!;
                                  },
                                );
                              }),
